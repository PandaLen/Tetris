...
class Block(pg.sprite.Sprite):
    ...
    # Nastavuje kdy se dokončí animace rozbití řady
    ...
    # Funkce nastaví pozici nového tetromina nahoru doprostřed herní mřížky
...
class Tetromino:
    ...
    # Funkce zajišťuje otáčení tetromina
    def rotate(self):
    ...
    # Funkce detekuje kolize
    def is_collide(self, block_positions):
        return any(map(Block.is_collide, self.blocks, block_positions))

    # Funkce pohybuje tetrominem dolů dokud nepřistane
